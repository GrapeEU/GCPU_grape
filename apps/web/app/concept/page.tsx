  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-12 px-8 py-20">
      <section className="flex flex-col gap-6">
        <h1 className="text-4xl font-bold text-left text-[#1C1C1C]">Trustworthy Agents Need a Verifiable Brain</h1>
      </section>

      <section className="flex flex-col gap-6">
        <h2 className="text-2xl font-semibold text-left text-[#1C1C1C]">The Web's Unfinished Dream</h2>
        ...
        <p className="text-lg leading-relaxed text-justify text-[#4B5563]">For decades, this power remained complex and gated behind semantic expertise.</p>
      </section>

      <section className="flex flex-col gap-6">
        <h2 className="text-2xl font-semibold text-left text-[#1C1C1C]">Reasoning vs. Guessing</h2>
        <p className="text-lg leading-relaxed text-justify text-[#4B5563]">LLMs are powerful at understanding and generating text, but they predict the next token—they don’t <em>prove</em> truth, which is why they hallucinate.</p>
        <p className="text-lg leading-relaxed text-justify text-[#4B5563]">A Knowledge Graph operates differently: it reasons with ontology rules and logical inference.</p>
      ...
      <section className="flex flex-col gap-6">
        <h2 className="text-2xl font-semibold text-left text-[#1C1C1C]">The Bottleneck: The Expert Problem</h2>
        <p className="text-lg leading-relaxed text-justify text-[#4B5563]">
      ...
      <section className="flex flex-col gap-6">
        <h2 className="text-2xl font-semibold text-left text-[#1C1C1C]">Our Vision: A Frugal, Trustworthy AI Stack</h2>
        <p className="text-lg leading-relaxed text-justify text-[#4B5563]">We separate the <em>brain</em> (KG + ontology) from the <em>parrot</em> (LLM).</p>
        <p className="text-lg leading-relaxed text-justify text-[#4B5563]">
        ...
        <p className="text-lg leading-relaxed text-justify text-[#4B5563]">Our mission is to democratize this stack. With Grape Builder, any domain expert can create a verifiable knowledge graph. Smaller, safer, and frugal AI—grounded in facts and auditable reasoning.</p>
      </section>
